...
<button class="modal-open bg-green-500 border border-green-600 hover:border-green-700 text-gray-200 hover:text-white py-2 px-4 rounded">{{ $buttonName }}</button>
